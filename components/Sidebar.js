  ...
  return (
    <div className="h-full hidden sm:flex flex-col fixed xl:ml-24">
      <nav className="h-full relative xl:space-y-1.5">
        ...
        <button className="hidden xl-inline bg-[#1d9bf0] rounded-full h-[52px] w-[200px] mt-2 text-lg font-bold">
          Tweet
        </button>
        <div
          onClick={handleSignOut}
          className="bottom-0 hover:bg-white hover:bg-opacity-10 rounded-full cursor-pointer absolute flex justify-center items-center xl:p-3 space-x-3 "
        >
          <img
